...
namespace ClaimatePrimeControllers.Controllers
{
    ...
    /// </summary>
    [Serializable]
    public class ModifierM_CURDController : BaseController
    {
        #region Search
        ...
        public ActionResult Search()
        {
            ...
            ModifierSearchModel objSearchModel = new ModifierSearchModel();
        ...
        {
            ModifierSearchModel objSearchModel = new ModifierSearchModel() { SearchName = pSearchName, StartBy = pStartBy, OrderByDirection = pOrderByDirection, OrderByField = pOrderByField };
            ...
            foreach (usp_GetBySearch_Modifier_Result item in objSearchModel.Modifier)
            {
        ...
        public ActionResult Save()
        {
            ...
            ModifierSaveModel objSaveModel = new ModifierSaveModel();
        ...
        public ActionResult Save(ModifierSaveModel objSaveModel)
        {
            //objSaveModel.Fill(ArivaSession.Sessions().UserID, IsActive());
            if (objSaveModel.Save(ArivaSession.Sessions().UserID))
            {
                ViewBagDotSuccMsg = 1;
                return ResponseDotRedirect("ModifierM", "Search", objSaveModel.Modifier.ModifierName.Substring(0, 1), 1);
            }
