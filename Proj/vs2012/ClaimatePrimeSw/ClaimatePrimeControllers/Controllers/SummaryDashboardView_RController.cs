...
{
    public class SummaryDashboardView_RController : BaseController
    {
        # region Constructors
        ...
        /// 
        /// </summary>
        public SummaryDashboardView_RController()
        {
        }
