...
namespace ClaimatePrimeControllers.Controllers
{
    ...
    /// </summary>
    [Serializable]
    public class County_URController : BaseController
    {
        #region County
        ...
        public ActionResult Search(CountySearchModel objSearchModel)
        {
            if (objSearchModel.CurrNumber > 0)
            {
                ...
                return ResponseDotRedirect("County", "Save");
            }
        ...
        public ActionResult BlockUnBlockAjaxCall(string pID, string pKy)
        {
            ...
            objSaveModel.County.IsActive = (string.Compare(pKy, "U", true) == 0) ? true : false;
            objSaveModel.County.Comment = string.Concat("BlockUnBlockAjaxCall Operation: ", (string.Compare(pKy, "U", true) == 0) ? "UNBLOCKED" : "BLOCKED");
