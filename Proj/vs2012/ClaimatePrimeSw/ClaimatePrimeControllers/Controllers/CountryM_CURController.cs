...
namespace ClaimatePrimeControllers.Controllers
{
    ...
    /// </summary>
    [Serializable]
    public class CountryM_CURController : BaseController
    {
        #region Search
        ...
        public ActionResult Search(CountrySearchModel objSearchModel)
        {
            if (objSearchModel.CurrNumber > 0)
            {
                ...
                return ResponseDotRedirect("CountryM", "Save");
            }
        ...
        public ActionResult Save(CountrySaveModel objSaveModel)
        {
            if (objSaveModel.Save(ArivaSession.Sessions().UserID))
            {
                return ResponseDotRedirect("CountryM", "Search", objSaveModel.Country.CountryName.Substring(0, 1), 1);
            }
            else
            {
