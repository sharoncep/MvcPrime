...
{
    public class UserRoleM_URController : BaseController
    {
        #region Search
        ...
        public ActionResult Search()
        {
            ...
            UserRoleSearchModel objSearchModel = new UserRoleSearchModel() { SelHighRoleID = Convert.ToByte(Role.EA_ROLE_ID), ManagerNameID = ArivaSession.Sessions().UserID };
        ...
        {
            UserRoleSearchModel objSearchModel = new UserRoleSearchModel() { SearchName = pSearchName, StartBy = pStartBy, SelHighRoleID = Convert.ToByte(Role.EA_ROLE_ID),ManagerNameID = ArivaSession.Sessions().UserID, OrderByDirection = pOrderByDirection, OrderByField = pOrderByField };
