...
{
    public class AssgnClaimsNITQ_URController : BaseController
    {
        # region Constructors
        ...
        /// 
        /// </summary>
        public AssgnClaimsNITQ_URController()
        {
        }
        ...
        public ActionResult Search()
        {
            ...
            AssignedClaimQASearchModel objSearchModel = new AssignedClaimQASearchModel() { ClinicID = ArivaSession.Sessions().SelClinicID, statusIDs = Convert.ToByte(ClaimStatus.QA_PERSONAL_QUEUE_NOT_IN_TRACK).ToString() };
        ...
        public ActionResult Search(AssignedClaimQASearchModel objSearchModel)
        {
            if (objSearchModel.CurrNumber > 0)
            {
                ...
                return ResponseDotRedirect("AssgnClaimsNITQ", "Save");
            }
            objSearchModel.ClinicID = ArivaSession.Sessions().SelClinicID;
            objSearchModel.statusIDs = Convert.ToByte(ClaimStatus.QA_PERSONAL_QUEUE_NOT_IN_TRACK).ToString();
            objSearchModel.FillCs(IsActive());
            return ResponseDotRedirect(objSearchModel);
        }
        #endregion
        ...
        public ActionResult Save(AssignedClaimQASaveModel objSaveModel)
        {
            ...
            {
                return ResponseDotRedirect("UnassgnClaimsNITQ", "Search", 0, 1);
            }
