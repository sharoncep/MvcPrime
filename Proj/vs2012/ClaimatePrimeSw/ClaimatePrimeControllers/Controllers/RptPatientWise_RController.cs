...
namespace ClaimatePrimeControllers.Controllers
{
    ...
    /// </summary>
    [Serializable]
    public class RptPatientWise_RController : BaseController
    {
        # region Search
        ...
        public ActionResult Search()
        {
            ...
            objSearch.Fill(ArivaSession.Sessions().UserID, Convert.ToByte(ExcelReportType.PATIENT_REPORT), false, ArivaSession.Sessions().SelPatientID, DateTime.Now.AddSeconds(StaticClass.SvrTimeSecDiff));
        ...
        public ActionResult ReImport()
        {
            ...
            try
            {
                ...
                string[] args = { Convert.ToString(ArivaSession.Sessions().UserID)
                                    , Convert.ToString(Convert.ToByte(ExcelReportType.PATIENT_REPORT))
                                    , Convert.ToString(ArivaSession.Sessions().SelPatientID)
                                    , "1900", "1", "2"
                                    , "1900", "1", "1" };
        ...
        /// <returns></returns>
        [AcceptVerbs(HttpVerbs.Get)]
        public ActionResult PatientDash()
        {
        ...
        public ActionResult DateWise()
        {
            ...
            objSearch.Fill(ArivaSession.Sessions().UserID, Convert.ToByte(ExcelReportType.PATIENT_REPORT), true, ArivaSession.Sessions().SelPatientID, DateTime.Now.AddSeconds(StaticClass.SvrTimeSecDiff));
        ...
        public ActionResult DateWise(UserReportSearchModel objModel)
        {
            ...
            return ResponseDotRedirect("RptPatientWise", "DateWise");
        }
