...
{
    public class AssgnClaimsNITE_URController : BaseController
    {
        # region Constructors
        ...
        /// 
        /// </summary>
        public AssgnClaimsNITE_URController()
        {
        }
        ...
        public ActionResult Search()
        {
            ...
            AssignedClaimEASearchModel objSearchModel = new AssignedClaimEASearchModel() { ClinicID = ArivaSession.Sessions().SelClinicID, statusIDs = Convert.ToByte(ClaimStatus.EA_PERSONAL_QUEUE_NOT_IN_TRACK).ToString() };
        ...
        public ActionResult Search(AssignedClaimEASearchModel objSearchModel)
        {
            if (objSearchModel.CurrNumber > 0)
            {
                ...
                return ResponseDotRedirect("AssgnClaimsNITE", "Save");
            }

            objSearchModel.ClinicID = ArivaSession.Sessions().SelClinicID;
            objSearchModel.statusIDs = Convert.ToByte(ClaimStatus.EA_PERSONAL_QUEUE_NOT_IN_TRACK).ToString();
            objSearchModel.FillCs(IsActive());
            return ResponseDotRedirect(objSearchModel);
        }
        #endregion
        ...
        public ActionResult SaveHold(AssignedClaimEASaveModel objSaveModel)
        {
            ...
            {
                return ResponseDotRedirect("UnassgnClaimsNITE", "Search", 0, 1);
            }
