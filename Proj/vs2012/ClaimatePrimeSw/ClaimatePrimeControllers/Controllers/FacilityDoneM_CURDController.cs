...
namespace ClaimatePrimeControllers.Controllers
{
    ...
    /// </summary>
    [Serializable]
    public class FacilityDoneM_CURDController : BaseController
    {
        #region Search
        ...
        public ActionResult Search()
        {
            ...
            FacilityDoneSearchModel objSearchModel = new FacilityDoneSearchModel();
        ...
        public ActionResult Search(FacilityDoneSearchModel objSearchModel)
        {
            if (objSearchModel.CurrNumber > 0)
            {
                ArivaSession.Sessions().PageEditID<global::System.Int64>(objSearchModel.CurrNumber);

                return ResponseDotRedirect("FacilityDoneM", "Save");
            }
        ...
        {
            FacilityDoneSearchModel objSearchModel = new FacilityDoneSearchModel() { SearchName = pSearchName, StartBy = pStartBy, OrderByDirection = pOrderByDirection, OrderByField = pOrderByField };
            ...
            foreach (usp_GetBySearch_FacilityDone_Result item in objSearchModel.FacilityDone)
            {
        ...
        public ActionResult Save()
        {
            ...
            FacilityDoneSaveModel objSaveModel = new FacilityDoneSaveModel();
        ...
        public ActionResult Save(FacilityDoneSaveModel objSaveModel)
        {
            //objSaveModel.Fill(ArivaSession.Sessions().UserID, IsActive());
            if (objSaveModel.Save(ArivaSession.Sessions().UserID))
            {

                return ResponseDotRedirect("FacilityDoneM", "Search", objSaveModel.FacilityDone.FacilityDoneName.Substring(0, 1), 1);
            }
