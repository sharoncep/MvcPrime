...
namespace ClaimatePrimeControllers.Controllers
{
    ...
    /// </summary>
    [Serializable]
    public class DiagnosisGroup_CURDController : BaseController
    {
        #region Search
        ...
        public ActionResult Search()
        {
            ...
            DiagnosisGroupSearchModel objSearchModel = new DiagnosisGroupSearchModel();
        ...
        public ActionResult Search(DiagnosisGroupSearchModel objSearchModel)
        {
            if (objSearchModel.CurrNumber > 0)
            {
                ArivaSession.Sessions().PageEditID<global::System.Int64>(objSearchModel.CurrNumber);

                return ResponseDotRedirect("DiagnosisGroup", "Save");
            }
        ...
        {
            DiagnosisGroupSearchModel objSearchModel = new DiagnosisGroupSearchModel() { SearchName = pSearchName, StartBy = pStartBy, OrderByDirection = pOrderByDirection, OrderByField = pOrderByField };
            ...
            foreach (usp_GetBySearch_DiagnosisGroup_Result item in objSearchModel.Counties)
            {
        ...
        public ActionResult Save()
        {
            ...
            DiagnosisGroupSaveModel objSaveModel = new DiagnosisGroupSaveModel();
        ...
        public ActionResult Save(DiagnosisGroupSaveModel objSaveModel)
        {
            //objSaveModel.Fill(ArivaSession.Sessions().UserID, IsActive());
            if (objSaveModel.Save(ArivaSession.Sessions().UserID))
            {

                return ResponseDotRedirect("DiagnosisGroup", "Search", objSaveModel.DiagnosisGroup.DiagnosisGroupDescription.Substring(0, 1), 1);
            }
            else
            {
