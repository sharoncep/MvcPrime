...
{
    public class TransPurpsCodeM_CURDController : BaseController
    {
        #region Search
        ...
        public ActionResult Search()
        {
            ...
            TransactionPurposeCodeSearchModel objSearchModel = new TransactionPurposeCodeSearchModel();
        ...
        public ActionResult Search(TransactionPurposeCodeSearchModel objSearchModel)
        {
            if (objSearchModel.CurrNumber > 0)
            {
                ArivaSession.Sessions().PageEditID<global::System.Byte>(objSearchModel.CurrNumber);

                return ResponseDotRedirect("TransPurpsCodeM", "Save");
            }
        ...
        {
            TransactionPurposeCodeSaveModel objModel = new TransactionPurposeCodeSaveModel();
        ...
        public ActionResult Save(TransactionPurposeCodeSaveModel objmodel)
        {
            bool saveTransactionPurposeCode = objmodel.Save(ArivaSession.Sessions().UserID);
            if (saveTransactionPurposeCode)
            {
                return ResponseDotRedirect("TransPurpsCodeM", "Search", 0, 1);
            }
            else
            {
