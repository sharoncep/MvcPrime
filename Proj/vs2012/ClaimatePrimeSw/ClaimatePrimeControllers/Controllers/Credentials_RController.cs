...
namespace ClaimatePrimeControllers.Controllers
{
    ...
    /// </summary>
    [Serializable]
    public class Credentials_RController : BaseController
    {
        #region Search
        ...
        public ActionResult Search()
        {
            ...
            CredentialSearchModel objSearchModel = new CredentialSearchModel();
        ...
        {
            CredentialSaveModel objModel = new CredentialSaveModel();
        ...
        public ActionResult Save(CredentialSaveModel objmodel)
        {
            bool saveCredential = objmodel.Save(ArivaSession.Sessions().UserID);
            if (saveCredential)
            {
                return ResponseDotRedirect("Credentials", "Search", 0, 1);
            }
            else
            {
                ViewBagDotErrMsg = 1;
