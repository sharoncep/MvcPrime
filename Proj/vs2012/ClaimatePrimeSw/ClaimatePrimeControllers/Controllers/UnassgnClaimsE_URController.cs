...
{
    public class UnassgnClaimsE_URController : BaseController
    {
        #region Search
        ...
        public ActionResult Search()
        {
            ...
            UnassignedClaimEASearchModel objSearchModel = new UnassignedClaimEASearchModel() { ClinicID = ArivaSession.Sessions().SelClinicID, StatusIDs = string.Concat(Convert.ToByte(ClaimStatus.EA_GENERAL_QUEUE), ", ", Convert.ToByte(ClaimStatus.EA_GENERAL_QUEUE_NOT_IN_TRACK)) };
        ...
        public ActionResult Search(UnassignedClaimEASearchModel objSearchModel)
        {
            if (objSearchModel.CurrNumber > 0)
            {
                ArivaSession.Sessions().PageEditID<global::System.Int64>(objSearchModel.CurrNumber);
                objSearchModel._CommentForEAPerQ = "Sys Gen : EA_PERSONAL_QUEUE";
                if (objSearchModel.Save(ArivaSession.Sessions().UserID, IsActive(true)))
                {
                    return ResponseDotRedirect("AssgnClaimsE", "Save", 0, 1);
                }
                else
                {
                    return ResponseDotRedirect("UnassgnClaimsE", "Search", 0, 101);
                }
            }

            objSearchModel.ClinicID = ArivaSession.Sessions().SelClinicID;
            objSearchModel.StatusIDs = string.Concat(Convert.ToByte(ClaimStatus.EA_GENERAL_QUEUE), ", ", Convert.ToByte(ClaimStatus.EA_GENERAL_QUEUE_NOT_IN_TRACK));
            //objSearchModel.Fill(IsActive());
            return ResponseDotRedirect(objSearchModel);
        }
        ...
        public ActionResult View(UnassignedClaimEASearchModel objSearchModel)
        {
            if (objSearchModel.CurrNumber > 0)
            {
                ArivaSession.Sessions().PageEditID<global::System.Int64>(objSearchModel.CurrNumber);

                return ResponseDotRedirect("UnassgnClaimsE", "Save", 0, 1);
            }
        ...
        {
            UnassignedClaimEASearchModel objSearchModel = new UnassignedClaimEASearchModel()
            {
                ...
                ,
                StatusIDs = string.Concat(Convert.ToByte(ClaimStatus.EA_GENERAL_QUEUE), ", ", Convert.ToByte(ClaimStatus.EA_GENERAL_QUEUE_NOT_IN_TRACK))
            };
