...
{
    public class UnassgnClaimsNITB_URController : BaseController
    {
        #region Search
        ...
        public ActionResult Search()
        {
            ...
            UnassignedClaimSearchModel objSearchModel = new UnassignedClaimSearchModel()
            {
                ...
                ,
                statusIDs = Convert.ToByte(ClaimStatus.BA_GENERAL_QUEUE_NOT_IN_TRACK).ToString()
            };
        ...
        public ActionResult Search(UnassignedClaimSearchModel objSearchModel)
        {
            if (objSearchModel.CurrNumber > 0)
            {
                ...
                {
                    return ResponseDotRedirect("AssgnClaimsNITB", "Save", 0, 1);
                }
                else
                {
                    return ResponseDotRedirect("UnassgnClaimsNITB", "Search", 0, 101);
                }
            }

            objSearchModel.ClinicID = ArivaSession.Sessions().SelClinicID;
            objSearchModel.statusIDs = Convert.ToByte(ClaimStatus.BA_GENERAL_QUEUE_NOT_IN_TRACK).ToString();
            // objSearchModel.Fill(IsActive());
            return ResponseDotRedirect(objSearchModel);
        }
        ...
        public ActionResult View(UnassignedClaimSearchModel objSearchModel)
        {
            if (objSearchModel.CurrNumber > 0)
            {
                ...
                return ResponseDotRedirect("UnassgnClaimsNITB", "Save", 0, 1);
            }
