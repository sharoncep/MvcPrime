...
namespace ClaimatePrimeControllers.Controllers
{
    ...
    /// </summary>
    [Serializable]
    public class RptClinicWise_RController : BaseController
    {
        # region Search
        ...
        public ActionResult Search()
        {
            ...
            objSearch.Fill(ArivaSession.Sessions().UserID, Convert.ToByte(ExcelReportType.CLINIC_REPORT), false, ArivaSession.Sessions().SelClinicID, DateTime.Now.AddSeconds(StaticClass.SvrTimeSecDiff));
        ...
        public ActionResult ReImport()
        {
            ...
            try
            {
                ...
                string[] args = { Convert.ToString(ArivaSession.Sessions().UserID)
                                    ...
                                    , Convert.ToString(ArivaSession.Sessions().SelClinicID)
                                    , "1900", "1", "2"
                                    , "1900", "1", "1" };
        ...
        /// <returns></returns>
        [AcceptVerbs(HttpVerbs.Get)]
        public ActionResult ProviderNameList()
        {
            ...
            ProviderReportSearchModel objSearchModel = new ProviderReportSearchModel() { StartBy = stby, ClinicID = ArivaSession.Sessions().SelClinicID };
        ...
        /// <returns></returns>
        [AcceptVerbs(HttpVerbs.Get)]
        public ActionResult PatientNameList()
        {
            ...
            PatientRptSearch objSearchModel = new PatientRptSearch() { StartBy = stby, ClinicID = ArivaSession.Sessions().SelClinicID };
            objSearchModel.Fill(IsActive());
        ...
        public ActionResult DateWise()
        {
            ...
            objSearch.Fill(ArivaSession.Sessions().UserID, Convert.ToByte(ExcelReportType.CLINIC_REPORT), true, ArivaSession.Sessions().SelClinicID, DateTime.Now.AddSeconds(StaticClass.SvrTimeSecDiff));
        ...
        public ActionResult DateWise(UserReportSearchModel objModel)
        {
            ...
            return ResponseDotRedirect("RptClinicWise", "DateWise");
        }
