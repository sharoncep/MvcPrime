...
{
    public class TransTypeCodeM_CURDController : BaseController
    {
        #region Search
        ...
        public ActionResult Search()
        {
            ...
            TransactionTypeCodeSearchModel objSearchModel = new TransactionTypeCodeSearchModel();
        ...
        public ActionResult Search(TransactionTypeCodeSearchModel objSearchModel)
        {
            if (objSearchModel.CurrNumber > 0)
            {
                ArivaSession.Sessions().PageEditID<global::System.Byte>(objSearchModel.CurrNumber);

                return ResponseDotRedirect("TransTypeCodeM", "Save");
            }
        ...
        {
            TransactionTypeCodeSaveModel objModel = new TransactionTypeCodeSaveModel();
        ...
        public ActionResult Save(TransactionTypeCodeSaveModel objmodel)
        {
            bool saveTransactionTypeCode = objmodel.Save(ArivaSession.Sessions().UserID);
            if (saveTransactionTypeCode)
            {
                return ResponseDotRedirect("TransTypeCodeM", "Search", 0, 1);
            }
            else
            {
