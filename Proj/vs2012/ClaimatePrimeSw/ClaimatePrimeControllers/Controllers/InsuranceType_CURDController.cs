...
{
    public class InsuranceType_CURDController : BaseController
    {
        #region Search
        ...
        public ActionResult Search()
        {
            ...
            InsuranceTypeSearchModel objSearchModel = new InsuranceTypeSearchModel();
        ...
        public ActionResult Search(InsuranceTypeSearchModel objSearchModel)
        {
            if (objSearchModel.CurrNumber > 0)
            {
                ArivaSession.Sessions().PageEditID<global::System.Byte>(objSearchModel.CurrNumber);

                return ResponseDotRedirect("InsuranceType", "Save");
            }
        ...
        {
            InsuranceTypeSaveModel objModel = new InsuranceTypeSaveModel();
        ...
        public ActionResult Save(InsuranceTypeSaveModel objmodel)
        {
            bool saveInsuranceType = objmodel.Save(ArivaSession.Sessions().UserID);
            if (saveInsuranceType)
            {
                return ResponseDotRedirect("InsuranceType", "Search", objmodel.InsuranceType.InsuranceTypeName.Substring(0, 1), 1);
            }
            else
            {
