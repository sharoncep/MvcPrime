...
namespace ClaimatePrimeControllers.Controllers
{
    ...
    /// 
    /// </summary>
    public class AssgnClaimsE_URController : BaseController
    {
        # region Constructors
        ...
        /// 
        /// </summary>
        public AssgnClaimsE_URController()
        {
        }
        ...
        public ActionResult Search()
        {
            ...
            AssignedClaimEASearchModel objSearchModel = new AssignedClaimEASearchModel() { ClinicID = ArivaSession.Sessions().SelClinicID, statusIDs = string.Concat(Convert.ToByte(ClaimStatus.EA_PERSONAL_QUEUE), ", ", Convert.ToByte(ClaimStatus.EA_PERSONAL_QUEUE_NOT_IN_TRACK)), AssignedTo = ArivaSession.Sessions().UserID };
        ...
        public ActionResult Search(AssignedClaimEASearchModel objSearchModel)
        {
            if (objSearchModel.CurrNumber > 0)
            {
                ArivaSession.Sessions().PageEditID<global::System.Int64>(objSearchModel.CurrNumber);

                return ResponseDotRedirect("AssgnClaimsE", "Save");
            }

            objSearchModel.ClinicID = ArivaSession.Sessions().SelClinicID;
            objSearchModel.statusIDs = string.Concat(Convert.ToByte(ClaimStatus.EA_PERSONAL_QUEUE), ", ", Convert.ToByte(ClaimStatus.EA_PERSONAL_QUEUE_NOT_IN_TRACK));
        ...
        public ActionResult Save()
        {
            ...
            AssignedClaimEASaveModel objSaveModel = new AssignedClaimEASaveModel();
        ...
        public ActionResult SaveHold(AssignedClaimEASaveModel objSaveModel)
        {
            objSaveModel.PatientVisitID = ArivaSession.Sessions().PageEditID<long>();

            objSaveModel.CommentForReasgn = "Sys Gen : REASSIGNED_BY_EA_TO_QA";

            if (objSaveModel.Save(ArivaSession.Sessions().UserID))
            {
                return ResponseDotRedirect("UnassgnClaimsE", "Search", 0, 1);
            }
