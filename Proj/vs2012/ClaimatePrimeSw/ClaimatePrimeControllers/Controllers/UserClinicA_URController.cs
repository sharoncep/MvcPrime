...
{
    public class UserClinicA_URController : BaseController
    {
        #region Search
        ...
        public ActionResult Search()
        {
            ...
            UserClinicSearchModel objModel = new UserClinicSearchModel() { SelHighRoleID = Convert.ToByte(Role.EA_ROLE_ID) };
        ...
        {
            UserClinicSearchModel objSearchModel = new UserClinicSearchModel() { SelHighRoleID = Convert.ToByte(Role.EA_ROLE_ID), SearchName = pSearchName, StartBy = pStartBy, OrderByDirection = pOrderByDirection, OrderByField = pOrderByField };
