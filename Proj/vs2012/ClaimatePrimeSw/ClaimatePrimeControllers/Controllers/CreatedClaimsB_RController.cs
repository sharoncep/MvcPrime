...
namespace ClaimatePrimeControllers.Controllers
{
    ...
    /// 
    /// </summary>
    public class CreatedClaimsB_RController : BaseController
    {
        # region Constructors
        ...
        /// 
        /// </summary>
        public CreatedClaimsB_RController()
        {
        }
        ...
        public ActionResult Search()
        {
            ...
            CreatedClaimSearchModel objSearchModel = new CreatedClaimSearchModel()
            {
        ...
        public ActionResult Search(CreatedClaimSearchModel objSearchModel)
        {
            if (objSearchModel.CurrNumber > 0)
            {
                ArivaSession.Sessions().PageEditID<global::System.Int64>(objSearchModel.CurrNumber);

                return ResponseDotRedirect("CreatedClaimsB", "Save");
            }
