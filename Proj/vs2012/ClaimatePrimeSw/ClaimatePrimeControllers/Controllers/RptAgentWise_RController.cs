...
{
    public class RptAgentWise_RController : BaseController
    {
        ...
        public ActionResult ReImport()
        {
            ...
            try
            {
                ...
                string[] args = { Convert.ToString(ArivaSession.Sessions().UserID)
                                    , Convert.ToString(Convert.ToByte(ExcelReportType.AGENT_REPORT))
                                    ,  Convert.ToString(ArivaSession.Sessions().SelAgentID)
                                    , "1900", "1", "2"
                                    , "1900", "1", "1" };
        ...
        public ActionResult AgentWise()
        {
            ...
            objSearch.Fill(ArivaSession.Sessions().UserID, Convert.ToByte(ExcelReportType.AGENT_REPORT), false, ArivaSession.Sessions().SelAgentID, DateTime.Now.AddSeconds(StaticClass.SvrTimeSecDiff));
        ...
        public ActionResult DateWise(UserReportSearchModel objModel)
        {
            ...
            return ResponseDotRedirect("RptAgentWise", "DateWise");
        }
