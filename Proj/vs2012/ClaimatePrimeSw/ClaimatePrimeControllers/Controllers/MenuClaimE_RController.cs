...
{
    public class MenuClaimE_RController:BaseController
    {
        #region Search
        ...
        public ActionResult Search()
        {
            ...
            { 
                ...
                ,
                UnassigneClaimStatus = string.Concat(Convert.ToByte(ClaimStatus.EA_GENERAL_QUEUE), ", ", Convert.ToByte(ClaimStatus.EA_GENERAL_QUEUE_NOT_IN_TRACK))
                ,
                UnassigneClaimNITStatus =Convert.ToByte(ClaimStatus.EA_GENERAL_QUEUE_NOT_IN_TRACK).ToString()
                ,
                AssigneClaimStatus = string.Concat(Convert.ToByte(ClaimStatus.EA_PERSONAL_QUEUE), ", ", Convert.ToByte(ClaimStatus.EA_PERSONAL_QUEUE_NOT_IN_TRACK))
                ,
                AssigneClaimNITStatus = Convert.ToByte(ClaimStatus.EA_PERSONAL_QUEUE_NOT_IN_TRACK).ToString()
                ,
