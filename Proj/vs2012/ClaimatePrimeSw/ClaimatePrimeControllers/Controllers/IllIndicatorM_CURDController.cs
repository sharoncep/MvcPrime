...
namespace ClaimatePrimeControllers.Controllers
{
    ...
    /// </summary>
    [Serializable]
    public class IllIndicatorM_CURDController : BaseController
    {
        #region Search
        ...
        public ActionResult Search()
        {
            ...
            IllnessIndicatorSearchModel objSearchModel = new IllnessIndicatorSearchModel();
        ...
        public ActionResult Search(IllnessIndicatorSearchModel objSearchModel)
        {
            if (objSearchModel.CurrNumber > 0)
            {
                ArivaSession.Sessions().PageEditID<global::System.Int64>(objSearchModel.CurrNumber);

                return ResponseDotRedirect("IllIndicatorM", "Save");
            }
        ...
        {
            IllnessIndicatorSearchModel objSearchModel = new IllnessIndicatorSearchModel() { SearchName = pSearchName, StartBy = pStartBy, OrderByDirection = pOrderByDirection, OrderByField = pOrderByField };
            ...
            foreach (usp_GetBySearch_IllnessIndicator_Result item in objSearchModel.IllnessIndicator)
            {
        ...
        public ActionResult Save()
        {
            ...
            IllnessIndicatorSaveModel objSaveModel = new IllnessIndicatorSaveModel();
        ...
        public ActionResult Save(IllnessIndicatorSaveModel objSaveModel)
        {
            //objSaveModel.Fill(ArivaSession.Sessions().UserID, IsActive());
            if (objSaveModel.Save(ArivaSession.Sessions().UserID))
            {
                ViewBagDotSuccMsg = 1;
                return ResponseDotRedirect("IllIndicatorM", "Search", objSaveModel.IllnessIndicator.IllnessIndicatorName.Substring(0, 1), 1);
            }
