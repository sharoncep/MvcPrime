...
{
    public class MenuClaim_RController : BaseController
    {
        #region Search
        ...
        public ActionResult Search()
        {
            ...
            MenuClaimSearchModel objMenuClaim = new MenuClaimSearchModel()
            {
                ...
                ,
                UnassigneClaimStatus = string.Concat(Convert.ToByte(ClaimStatus.BA_GENERAL_QUEUE), ", ", Convert.ToByte(ClaimStatus.BA_GENERAL_QUEUE_NOT_IN_TRACK))
                ,
                UnassigneClaimNITStatus = Convert.ToByte(ClaimStatus.BA_GENERAL_QUEUE_NOT_IN_TRACK).ToString()
                ,
                AssigneClaimStatus = string.Concat(Convert.ToByte(ClaimStatus.BA_PERSONAL_QUEUE), ", ", Convert.ToByte(ClaimStatus.BA_PERSONAL_QUEUE_NOT_IN_TRACK), ", ", Convert.ToByte(ClaimStatus.HOLD_CLAIM), ", ", Convert.ToByte(ClaimStatus.UNHOLD_CLAIM))
                ,
                AssigneClaimNITStatus = string.Concat(Convert.ToByte(ClaimStatus.BA_PERSONAL_QUEUE_NOT_IN_TRACK), ", ", Convert.ToByte(ClaimStatus.HOLD_CLAIM_NOT_IN_TRACK))
                ,
                CreatedClaimStatus = string.Concat
                   (
                   Convert.ToByte(ClaimStatus.QA_GENERAL_QUEUE)
                   , ", ", Convert.ToByte(ClaimStatus.QA_GENERAL_QUEUE_NOT_IN_TRACK)
                   , ", ", Convert.ToByte(ClaimStatus.QA_PERSONAL_QUEUE)
                   , ", ", Convert.ToByte(ClaimStatus.QA_PERSONAL_QUEUE_NOT_IN_TRACK)
                   ...
                   , ", ", Convert.ToByte(ClaimStatus.REASSIGNED_BY_EA_TO_QA)
