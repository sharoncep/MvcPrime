...
namespace ClaimatePrimeControllers.Controllers
{
    ...
    /// </summary>
    [Serializable]
    public class ProviderBlock_URController : BaseController
    {
        #region ProviderBlock
        ...
        public ActionResult Search()
        {
            ...
            ProviderSearchModel objSearchModel = new ProviderSearchModel();
        ...
        public ActionResult Search(ProviderSearchModel objSearchModel)
        {
            if (objSearchModel.CurrNumber > 0)
            {
                ...
                return ResponseDotRedirect("ProvidereBlock", "Save");
            }
        ...
        {
            ProviderSearchModel objSearchModel = new ProviderSearchModel() { SearchName = pSearchName, StartBy = pStartBy, OrderByDirection = pOrderByDirection, OrderByField = pOrderByField };
        ...
        public ActionResult BlockUnBlockAjaxCall(string pID, string pKy)
        {
            ...
            objSaveModel.Provider.IsActive = (string.Compare(pKy, "U", true) == 0) ? true : false;
            objSaveModel.Provider.Comment = string.Concat("BlockUnBlockAjaxCall Operation: ", (string.Compare(pKy, "U", true) == 0) ? "UNBLOCKED" : "BLOCKED");
