...
{
    public class SecurityQuali_CURDController : BaseController
    {
        #region Search
        ...
        public ActionResult Search()
        {
            ...
            SecurityQualifierSearchModel objSearchModel = new SecurityQualifierSearchModel();
        ...
        public ActionResult Search(SecurityQualifierSearchModel objSearchModel)
        {
            if (objSearchModel.CurrNumber > 0)
            {
                ArivaSession.Sessions().PageEditID<global::System.Byte>(objSearchModel.CurrNumber);

                return ResponseDotRedirect("SecurityQuali", "Save");
            }
        ...
        {
            SecurityQualifierSaveModel objModel = new SecurityQualifierSaveModel();
        ...
        public ActionResult Save(SecurityQualifierSaveModel objmodel)
        {
            bool saveSecurityQualifier = objmodel.Save(ArivaSession.Sessions().UserID);
            if (saveSecurityQualifier)
            {
                return ResponseDotRedirect("SecurityQuali", "Search", 0, 1);
            }
            else
            {
                ViewBagDotErrMsg = 1;
