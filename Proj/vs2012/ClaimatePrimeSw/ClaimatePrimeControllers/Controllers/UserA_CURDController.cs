...
namespace ClaimatePrimeControllers.Controllers
{
    ...
    /// </summary>
    [Serializable]
    public class UserA_CURDController : BaseController
    {
        #region Search
        ...
        public ActionResult Search()
        {
            ...
            UserSearchModel objSearchModel = new UserSearchModel() { SelHighRoleID = Convert.ToByte(Role.EA_ROLE_ID) };
        ...
        {
            UserSearchModel objSearchModel = new UserSearchModel() { SearchName = pSearchName, StartBy = pStartBy, SelHighRoleID = Convert.ToByte(Role.EA_ROLE_ID), OrderByDirection = pOrderByDirection, OrderByField = pOrderByField };
        ...
        public ActionResult Save(UserSaveModel objSaveModel, HttpPostedFileBase filUpload)
        {
            ...
            {
                if (filUpload.ContentLength > objSaveModel.GetFileSize())
                {
                    ViewBagDotErrMsg = 3;
                }
            ...
            if (objSaveModel.Save(ArivaSession.Sessions().UserID))
            {
                ...
                if (objSaveModel.ManagerChk == false)
                {
