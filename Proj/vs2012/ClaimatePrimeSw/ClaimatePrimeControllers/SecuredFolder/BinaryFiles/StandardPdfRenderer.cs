...
namespace ClaimatePrimeControllers.SecuredFolder.BinaryFiles
{
    ...
    public class StandardPdfRenderer
    {
        public byte[] Render(string htmlText, string pageTitle)
        {
            ...
            {
                using (var pdfDocument = new Document(PageSize.A4, BinaryFilesConstants.HorizontalMargin, BinaryFilesConstants.HorizontalMargin, BinaryFilesConstants.VerticalMargin, BinaryFilesConstants.VerticalMargin))
                {
