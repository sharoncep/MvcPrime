...
namespace ClaimatePrimeControllers.AjaxCalls.AsgnClaims
{
    ...
    public class PrevStatusResult
    {
        ...
        /// <returns></returns>
        public static explicit operator PrevStatusResult(usp_GetByPatientVisitID_ClaimProcess_Result pResult)
        {
            return (new PrevStatusResult()
            {
