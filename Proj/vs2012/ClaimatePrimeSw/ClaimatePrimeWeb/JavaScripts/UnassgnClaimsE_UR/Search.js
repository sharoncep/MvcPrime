...
function searchSuccess(data, status) {
    ...
    if (hml.length == 0) {
        ...
        hml = hml + " <td width=\"19%\" class=\"td-gridhead\">";
        hml = hml + "&nbsp;";
        hml = hml + "</td>";


        hml = hml + " <td width=\"6%\" class=\"td-gridhead\">";
        hml = hml + "&nbsp;";
        hml = hml + "</td>";
        ...
        if (status.toLowerCase() == 'success') {
            ...
            if (jsonData != null) {
                for (i in jsonData) {
                    ...
                    retAns = retAns + "<td>";
                    retAns = retAns + "<a href=\"#\" class=\"aAssign1\" rel=\"control_tile\" onclick=\"javascript:return setEdit('";
                    retAns = retAns + d.ID;
                    retAns = retAns + "');\">";
                    retAns = retAns + AlertMsgs.get("ASSIGN_TO_ME");
                    retAns = retAns + "</a>";
                    retAns = retAns + "</td>";

                    retAns = retAns + "<td>";
                    //retAns = retAns + "<input type=\"submit\" name=\"btnView\" id=\"btnView\" value=\"View\" onclick=\"javascript: return showAlert();\" />";
                    retAns = retAns + "<a href=\"#\" class=\"aView\" rel=\"control_tile\" onclick=\"javascript:return setView('";
                    retAns = retAns + d.ID;
                    retAns = retAns + "');\">";
