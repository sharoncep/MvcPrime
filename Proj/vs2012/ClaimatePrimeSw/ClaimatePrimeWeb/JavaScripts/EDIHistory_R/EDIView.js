...
function loadSearchResult() {
    ...
    if (($('#chkHasRec').is(':checked'))) {
        ...
        $.ajax({
            url: (_AppDomainPath + _CtrlrName + "/EDIViewAjaxCall/0/0/"),
            type: 'POST',
            data: params,
            ...
            error: function (req, status, errorObj) {
                ajaxCallError("EDIHistory_R --> EDIViewAjaxCall", req, status, errorObj);
            }
        });
    }
        ...
        if (status.toLowerCase() == 'success') {
            ...
            if (jsonData != null) {
                for (i in jsonData) {
                    ...
                    retAns = retAns + "<a href=\"#\" rel=\"control_tile\" class=\"aView\" onclick=\"javascript:return setEdit('";
                    retAns = retAns + d.ID;
                    retAns = retAns + "');\">";
